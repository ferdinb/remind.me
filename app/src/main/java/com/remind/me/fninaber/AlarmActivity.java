...
public class AlarmActivity extends Activity implements OnClickListener {
    ...
    private FninaberText editTitle;
    private FninaberText editNotes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateView = (FninaberText) findViewById(R.id.alarm_date);
        timeView = (FninaberText) findViewById(R.id.alarm_time);
        editTitle = (FninaberText) findViewById(R.id.alarm_title);
        editNotes = (FninaberText) findViewById(R.id.alarm_notes);

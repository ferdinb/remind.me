...
////        }
//
//        FninaberText timeView = (FninaberText) view.findViewById(R.id.adapter_task_time);
//        FninaberText titleView = (FninaberText) view.findViewById(R.id.adapter_task_title);
//        FninaberText notesView = (FninaberText) view.findViewById(R.id.adapter_task_notes);
//        FninaberText dateView = (FninaberText) view.findViewById(R.id.adapter_task_date);
...
//
//        if (task.getType().equalsIgnoreCase(Type.PHOTO.toString()) || task.getType().equalsIgnoreCase(Type.AUDIO.toString())) {
////            typeView.setVisibility(View.VISIBLE);
////            if (task.getType().equalsIgnoreCase(Type.AUDIO.toString())) {
////                Picasso.with(context).load(R.drawable.ic_audio).into(typeView);
////            }else{
////                Picasso.with(context).load(R.drawable.ic_camera).into(typeView);
////            }
//        }
//
...
//        }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.adapter_home_card, parent, false);
    }
